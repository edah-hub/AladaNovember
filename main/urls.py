...
urlpatterns = [
    ...
    path('stock_receipt/<int:stock_receipt_id>/update/', views.update_stock_receipt, name='update_stock_receipt'),
    ...
    path('delete_user_role/<str:role_id>/', views.delete_user_role, name='delete_user_role'),
